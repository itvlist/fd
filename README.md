...
[![Deploy to AWS](https://oneclick.amplifyapp.com/button.svg)](https://console.aws.amazon.com/amplify/home#/deploy?repo=https://github.com/itvlist/fd)
...
To disable it just add `//` to the beginning of [this line of code in app.js](https://github.com/itvlist/fd/blob/5355bbfa8cfe2b5d2e6e5aae41ea21936a3be9a5/app.js#L59) like so:
...
2. [Download the code](https://github.com/itvlist/fd/archive/master.zip)
3. Unzip it
...
The the core of the nodeunblocker.com has been extracted into a [standalone library](https://github.com/itvlist/fd) to make it more flexible, but everything you need to run the website is right here.
